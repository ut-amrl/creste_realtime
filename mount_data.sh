...
# Define variables
REMOTE_USER="arthurz"
REMOTE_HOST="robolang.csres.utexas.edu"
...
REMOTE_DIRS=("/scratch/arthurz/Datasets/lsmap_bags_processed/3d_raw/os1" "/scratch/arthurz/Datasets/lsmap_bags_processed/2d_rect/cam0" "/scratch/arthurz/Datasets/lsmap_bags_processed/calibrations")
